...
books.each do |book|
  ...
  if book[:read_status] == "Not Begun"
    book.update(is_review_added: false)
    ...
    book.update(is_review_added: random_bool)
  end

  if book[:is_notes_added] == true
    book.update(notes: Faker::Lorem.paragraph(sentence_count: 6, supplemental: true, random_sentences_to_add: rand(1..20)))
  end

  if book[:is_review_added] == true
    book.update(review: Faker::Lorem.paragraph(sentence_count: 15, supplemental: true, random_sentences_to_add: rand(1..30)))
  end
end
